# Django/Creme settings for creme_mlml project.
#
# Generated by 'creme creme_start_project' using Creme 2.4.7.
#
...
#INSTALLED_APPS.append('creme_mlml.mlml')
...
GENERATED_MEDIA_NAMES_MODULE = 'creme_mlml._generated_media_names'
...
#        ADMINS = [
#           (
#               os.environ['CREME_MLML_ADMIN_NAME'],
#               os.environ['CREME_MLML_ADMIN_EMAIL'],
#           ),
#        ]
#
#        # SECURITY WARNING: keep the secret key used in production secret!
#        # HINT: use 'creme build_secret_key --settings=creme_mlml.settings' to generate it.
#        SECRET_KEY = os.environ['CREME_MLML_SECRET_KEY']
#
#        DATABASES = {
#            'default': {
#                'ENGINE': os.environ.get(
#                    'CREME_MLML_DB_ENGINE',
...
#                ),
#
#                'USER': os.environ.get('CREME_MLML_DB_USER', ''),
#                'PASSWORD': os.environ.get('CREME_MLML_DB_PASSWORD', ''),
#
#                'HOST': os.environ.get('CREME_MLML_DB_PASSWORD', ''),
#                'PORT': os.environ.get('CREME_MLML_DB_PORT', ''),
#            },
#        }
#
